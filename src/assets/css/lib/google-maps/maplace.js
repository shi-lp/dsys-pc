;(function ($, window, google, undefined) {
  ...
  html_ullist = {
    html_a: function (i, hash, ttl) {
      ...
      var el_a = $('<a data-load="' + index + '" id="ullist_a_' + index + '" href="#' + index + '" title="' + title + '"><span>' + (title || ('#' + (i + 1))) + '</span></a>')
  ...
  Maplace = (function () {
    ...
    Maplace.prototype.create = {
      ...
      marker: function (index) {
        ...
        var orig_visible = point.visible !== false
        ...
        a = google.maps.event.addListener(marker, 'click', function () {
          ...
          // show infowindow?
          point_infow = point.show_infowindows !== false
    ...
    Maplace.prototype.open_infowindow = function (index, marker) {
      ...
      var point = this.o.locations[index]
      var type = point.type || this.o.infowindow_type
    ...
    Maplace.prototype.generate_controls = function () {
      ...
      var inner = $(this.get_html_controls()).css(this.o.controls_applycss ? {
        background: '#fff',
        padding: '5px',
    ...
    Maplace.prototype.ShowOnMenu = function (index) {
      ...
      if (typeof (index - 0) === 'number' && index >= 0 && index < this.ln) {
        var visible = this.o.locations[index].visible !== false
        var on_menu = this.o.locations[index].on_menu !== false
        if (visible && on_menu) {
          return true
        }
      }
    ...
    Maplace.prototype.Load = function (args) {
      ...
      if (!this.loaded) {
        ...
        for (i in this.o.listeners) {
          var map = this.oMap
          var myListener = this.o.listeners[i]
